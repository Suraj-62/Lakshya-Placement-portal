    ...
    <div className="min-h-screen bg-stone-950 flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10 animate-in fade-in slide-in-from-bottom-4 duration-700">
        ...
        <div className="flex flex-col items-center mb-8">
            ...
            <h1 className="text-3xl font-black text-teal-50 tracking-tighter">Access <span className="text-emerald-500">Recovery</span></h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                <div className="space-y-2">
                    ...
                    <div className="relative group/input">
                        <Mail className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-stone-700 group-focus-within/input:text-emerald-500 transition-colors" />
                        <input
                            type="email"
                            placeholder="user@example.com"
                            className="w-full bg-stone-950 border border-stone-800 rounded-2xl py-4 pl-12 pr-4 text-teal-50 font-bold focus:outline-none focus:ring-2 focus:ring-emerald-500/10 transition-all placeholder:text-stone-800"
                            value={email}
